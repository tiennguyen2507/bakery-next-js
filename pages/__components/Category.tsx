    ...
    <div className="my-4">
      ...
      <div className="grid grid-cols-2 gap-5">
        <div className="h-20 bg-[#F6F8FA] rounded-xl flex items-center gap-2 p-2 cursor-pointer active:bg-slate-100">
          <Image src={cake} alt="img" width={20}></Image>
          <div>
        ...
        <div className="h-20 bg-[#F6F8FA] rounded-xl flex items-center gap-2 p-2 cursor-pointer active:bg-slate-100">
          <Image src={nguQua} alt="img" width={20}></Image>
          <div>
        ...
        <div className="h-20 bg-[#F6F8FA] rounded-xl flex items-center gap-2 p-2 cursor-pointer active:bg-slate-100">
          <Image src={phaoHoa} alt="img" width={20}></Image>
          <div>
        ...
        <div className="h-20 bg-[#F6F8FA] rounded-xl flex items-center gap-2 p-2 cursor-pointer active:bg-slate-100">
          <Image src={vagetable} alt="img" width={20}></Image>
          <div>
